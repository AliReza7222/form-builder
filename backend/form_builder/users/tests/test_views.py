...
from form_builder.users.views import UserRedirectView
from form_builder.users.views import UserUpdateView
from form_builder.users.views import user_detail_view
